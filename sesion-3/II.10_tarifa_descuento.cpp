...
int main() {
   ...
   /*
   En un programa real se debería usar un struct para que cada objeto tenga un
   mínimo de puntos y un porcentaje, luego usando una lista ordenada por el
   número de puntos necesarios y hacer una iteración buscando cuál es el
   descuento correspondiente al número de puntos que tenga el usuario. Ya que
   con 10 o 20 casos se hace difícil de escalar
   */
